...
const handleAvatarError = (event) => {
  ...
  // 使用 shapes 风格作为备用（抽象标识符风格）
  event.target.src = `https://api.dicebear.com/7.x/shapes/svg?seed=${encodeURIComponent(seed)}&backgroundColor=b6e3f4,c0aede,d1d4f9,ffd5dc,ffdfbf`
}
...
<template>
  <div class="min-h-screen pb-20 text-slate-800 selection:bg-blue-100 selection:text-blue-900">
    ...
    <div class="fixed top-0 left-0 right-0 z-50 ">
      <div class="w-full mx-auto backdrop-blur-sm bg-white/80 shadow-sm ">
        <div class="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 p-1 ">
          <!-- 视图切换器 -->
